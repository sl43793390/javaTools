...
public final class JsoupUtil {
    ...
    public static Document getDocumentWithHeader(String url, String headerKey, String headerValue) throws Exception {
        ...
        if (StringUtils.isEmpty(headerKey) && StringUtils.isEmpty(headerValue)) {
            doc = getDocument(url);
        } else if (!StringUtils.isEmpty(headerKey) && !StringUtils.isEmpty(headerValue)){
    ...
    public static Document getDocumentWithData(String url, String dataKey, String dataValue) throws Exception {
        ...
        if (StringUtils.isEmpty(dataKey) && StringUtils.isEmpty(dataValue)) {
            doc = getDocument(url);
        } else if (!StringUtils.isEmpty(dataKey) && !StringUtils.isEmpty(dataValue)){
    ...
    public static Document getDocumentWithCookie(String url, String cookieKey, String cookieValue) throws Exception {
        ...
        if (StringUtils.isEmpty(cookieKey) && StringUtils.isEmpty(cookieValue)) {
            doc = getDocument(url);
        } else if (!StringUtils.isEmpty(cookieKey) && !StringUtils.isEmpty(cookieValue)){
    ...
    public static Document getDocument(String url, Map<String, String> bindData, String requestType) throws Exception {
        ...
        for (int j = 1; j <= maxRetry; j++) {
            ...
            try {
                ...
                if (bindData != null && bindData.size() != 0 && !StringUtils.isEmpty(requestType)) {
                    switch (requestType) {
