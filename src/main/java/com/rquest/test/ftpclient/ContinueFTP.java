...
public class ContinueFTP {
	...
	public static void main(String[] args) {
		...
		try {
			myFtp.connect("192.168.22.165", 21, "user1", "user1");
			...
			// String("走西口".getBytes("GBK"),"iso-8859-1"));
			 System.out.println(myFtp.upload("d:\\a.xml", "/03 开发共享/test/a.xml"));
			// System.out.println(myFtp.upload("E:\\走西口24.mp4","/央视走西口/新浪网/走西口24.mp4"));
//			System.out.println(myFtp.download("\\03 开发共享\\ysa.jar", "d:\\ysa.jar"));
			myFtp.disconnect();
		} catch (Exception e) {
