 ...
 * @author user
 */
public final class ExportListToExcel {

  /***
   * 构造方法
   */
  private ExportListToExcel() {
 ...
 /***
   ...
   *        sheet名称和表头值
   */
  public static void excelExport(List<?> dataList, Map<String, String> titleMap, String titleName,String fileName) {
    // 初始化workbook
    initHSSFWorkbook(titleName);
    // 标题行
    createTitleRow(titleMap, titleName);
    // 时间行
