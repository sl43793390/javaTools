...
import com.rquest.riskmaster.dto.ValuationAssumption;    
...
public class CloneUtils {    
    ...
    /**
     * 克隆的另一个方法，将该方法写到每个需要克隆的类中，调用该方法即可返回克隆的对象，性能是上面的1/6 较差；
     * @return
     */
//	　//Discription:[深度复制方法,需要对象及对象所有的对象属性都实现序列化]　
	  public ValuationAssumption myclone() {
		  ValuationAssumption copy = null;
...
//	　　// 将流序列化成对象
	          ...
	          copy = (ValuationAssumption) ois.readObject();
	      } catch (IOException e) {
	          e.printStackTrace();
