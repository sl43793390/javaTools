...
public class MessageDigester {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchProviderException {
		...
		System.out.println("------------------------------------------------------------------------------------------------\n\n");
//		System.out.println( digester.getDigest("SM3", message));
//		System.out.println( digester.getDigest("MD5", message));
//		System.out.println(DigestUtils.md5Hex(message));  //对比Commons-codec 结果一样；
//		查看所有算法实现
